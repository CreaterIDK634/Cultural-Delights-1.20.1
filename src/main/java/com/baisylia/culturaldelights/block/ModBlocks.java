...
import com.baisylia.culturaldelights.worldgen.tree.AvocadoPitGrower;
import com.baisylia.culturaldelights.worldgen.tree.AvocadoTreeGrower;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> EGGPLANT_PARMESAN_BLOCK = registerBlock("eggplant_parmesan_block",
            () -> new EggplantFeastBlock(BlockBehaviour.Properties.copy(vectorwing.farmersdelight.common.registry.ModBlocks.ROAST_CHICKEN_BLOCK.get()), ModItems.EGGPLANT_PARMESAN, true), false, 0);
